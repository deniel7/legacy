      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form-horizontal" id="frmData" method="post" action="{{ url('/packages') }}/{{ $packages['id'] }} }}" autocomplete="off">
              {{ csrf_field() }}
              {{ method_field('PUT') }}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="{{ old('nama') !== null ? old('nama') : $packages['nama'] }}">
                  </div>
                </div>

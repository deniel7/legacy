...
<div class="row">
    <div class="col-xs-8">
        ...
        <form class="form-horizontal" id="frmData" method="post" action="{{ url('/post-corsagelist') }}" autocomplete="off">
            {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <label class="control-label">Name of Family Guest Corsage</label>
                </div>
                <div class="col-md-6">
        ...
        <div class="box-footer">
            <div class="btn-group pull-left">
                <a href="{{ url('wedding-data-teapay') }}"><button type="button" class="navbar-brand btn btn-default pull-right"><p>Back</p></button>
            </div>
            <div class="btn-group pull-right">
                
                <button type="submit" class="navbar-brand btn btn-primary" id="btnSubmit"><i class="fa fa-check"></i> Save</button>&nbsp;&nbsp;&nbsp;
                <a href="{{ url('wedding-data-familyphotolist') }}"><button type="button" class="navbar-brand btn btn-default pull-right"><p>Next</p></button>
            </div>
        </div>
    </div>
</div>

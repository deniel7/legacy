...
<div class="row">
    <div class="col-xs-8">
        ...
        <hr/>
        <h2>Family Photo Session List</h2>
        
        <form class="form-horizontal" id="frmData" method="post" action="{{ url('/post-familyphotolist') }}" autocomplete="off">
            {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <label class="control-label">Name of Family</label>
                </div>
                <div class="col-md-6">
        ...
        <div class="box-footer">
            ...
            <div class="btn-group pull-right">
                ...
                <a href="{{ url('wedding-data-friendphotolist') }}"><button type="button" class="navbar-brand btn btn-default pull-right"><p>Next</p></button>
            </div>
        </div>
    </div>
</div>

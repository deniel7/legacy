          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <img src="http://www.gravatar.com/avatar/{{ md5(Auth::admin()->user()->email) }}?d=identicon" class="user-image" alt="User Image">
                <!-- hidden-xs hides the username on small devices so only the image appears. -->
                <span class="hidden-xs">{{ Auth::admin()->user()->full_name }}</span>
              </a>
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    ...
                    <small>Member since {{ Auth::admin()->user()->created_at->format('d F Y') }}</small>
                  </p>
                </li>
                <!-- Menu Body -->
